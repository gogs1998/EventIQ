...
## 6e. Consent, removal and retention
...
## 6f. The opt-in stylised portrait
...
5. **Give the promoter the record importer.** The endpoint exists; it needs a paste box in the card editor. This is the single biggest lever on the weakest part of the product, the undercard. The valuable version is not the fighter pasting their own link, it is the promoter pasting links for the thirty fighters who never reply — it turns a blank undercard into real stats and merely no photo. Section 8a.
